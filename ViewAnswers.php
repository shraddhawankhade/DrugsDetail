...
$S_UserName=$_GET['UserName'];	//Get the username from URL.
$D_Date=$_GET['Date'];	//Get the date from URL.
...
echo "<h3> $S_UserName Questionnaire And Answers sent on dated $D_Date</h3>";
...
<br/>
<a href="/DrugsDetail/DownloadViewAnswersPDF.php?UserName=<?php echo $S_UserName; ?> & Date=<?php echo $D_Date; ?>">Export to PDF</a>	<!Divert to DownloadViewQuestionnaireAnswersPDF.php page!><br/><br/>
